		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				if ($query->num_rows) {
                    ...
                    if ($url[0] == 'story_id') {
                        $this->request->get['story_id'] = $url[1];
                    }

					if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'help_category_id' && $url[0] != 'blog_article_id' && $url[0] != 'member_id' && $url[0] != 'story_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id') {
			...
			if (!isset($this->request->get['route'])) {
				if (isset($this->request->get['product_id'])) {
					...
					$this->request->get['route'] = 'extension/module/blog_nik/article';
				} elseif (isset($this->request->get['member_id'])) {
					$this->request->get['route'] = 'extension/module/our_team_nik';
				} elseif (isset($this->request->get['story_id'])) {
					$this->request->get['route'] = 'extension/module/stories_nik';
				}
			}
		// Redirect 301   
			...
			} elseif ($this->request->get['route'] == 'extension/module/blog_nik/article' && isset($this->request->get['blog_article_id'])) {
				$route = 'blog_article_id=' . (int)$this->request->get['blog_article_id'];
			} elseif ($this->request->get['route'] == 'extension/module/our_team_nik' && isset($this->request->get['member_id'])) {
				$route = 'member_id=' . (int)$this->request->get['member_id'];
			} elseif ($this->request->get['route'] == 'extension/module/stories_nik' && isset($this->request->get['story_id'])) {
				$route = 'story_id=' . (int)$this->request->get['story_id'];
